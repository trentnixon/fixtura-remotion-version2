 ...
 * Set on {@link TemplateThemeConfig.broadcastProRoundedRosterListSizing} in `variants/broadcastProRounded/theme/tokens.ts`.
 */

export interface BroadcastProRoundedRosterListSizing {
...
/** Defaults; override per template in `broadcastProRounded/theme/tokens.ts`. */
export const DEFAULT_BROADCAST_PRO_ROSTER_LIST_SIZING: BroadcastProRoundedRosterListSizing =
  {
...
export const getBroadcastProRoundedRosterSidebarWidth = (
