...
export const mudgeerabaTheme: TemplateThemeConfig = {
  ...
  componentStyles: {
    ...
    ResultScoreYetToBat: {
      className: "text-3xl font-bold tracking-tight py-4",
    },
    ResultTeamName: {
    ...
    metadataLarge: {
      className: "text-2xl font-normal  tracking-widest leading-snug",
    },
  },
