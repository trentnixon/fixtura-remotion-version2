...
interface MudgeerabaOutroProps {
...
const GRID_SETTINGS = {
  columns: 2,
  rows: 3,
  gap: "0.25rem", // Tailwind gap-1 equivalent
  containerMaxWidth: 1600,
  containerMaxHeight: 900,
  cellMaxSize: 600,
  cellPadding: 16, // px, matches Tailwind p-4
  cellAspectRatio: "1 / 1",
  chunkSize: 6,
...
export const MudgeerabaOutro: React.FC<MudgeerabaOutroProps> = ({
  ...
  const groups = chunkSponsors(sponsorsArray, GRID_SETTINGS.chunkSize);
