...
export interface BrickworkAssetAtmosphereProps
  extends Partial<TextureOverlayProps> {
  children: ReactNode;
  className?: string;
  style?: CSSProperties;
}
...
export const BrickworkAssetAtmosphere: React.FC<
  BrickworkAssetAtmosphereProps
> = ({ children, className = "", style, ...textureProps }) => (
