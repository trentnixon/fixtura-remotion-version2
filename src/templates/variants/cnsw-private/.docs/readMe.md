...
CNSW Private variant: a clean, modern style extending the base template with navy and light tones (private variant).

## Files

- `index.tsx`: entry point exporting the CNSW Private variant composition
