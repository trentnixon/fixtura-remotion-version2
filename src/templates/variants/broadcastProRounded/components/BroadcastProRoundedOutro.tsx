...
interface BroadcastProRoundedOutroProps {
...
const SponsorGrid: React.FC<{
  ...
  imageRadius: string;
}> = ({ sponsors, LogoAnimations, imageRadius }) => (
  <div
    ...
    {sponsors
      ...
      .map((sponsor, idx) => (
        <div
          ...
          className={`flex h-full w-full items-center justify-center overflow-hidden ${imageRadius}`}
          style={{
