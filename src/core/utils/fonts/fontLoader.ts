 ...
 *
 * All fonts are stored locally in public/fonts/ directory.
 * To add a new Google Font:
 * 1. Download the font from Google Fonts
 * 2. Add font files to public/fonts/{FontName}/ directory
 * 3. Add entry to fontPathMap below
 */
 ...
 * 1. Download the font (if it's a Google Font, download from fonts.google.com)
 * 2. Add the font files to the public/fonts/{FontName}/ directory
 * 3. Add an entry to this map with the format:
 *    "FontName": "fonts/FontName/font-file.ttf"
 *
 * For weight variants, use the format:
 *    "FontName-Weight": "fonts/FontName/weight-variant.ttf"
...
export const fontPathMap: Record<string, string> = {
  ...
  // Heebo family (Google Font - downloaded and stored locally)
  ...
  // Roboto family (Google Font - downloaded and stored locally)
...
export const loadFontsFromTheme = async (
  ...
  if (theme.fonts) {
    ...
    const additional = (theme.fonts as { additional?: string[] | undefined })
      .additional;
