...
import FixtureDisplayScoreline from "./controller/GamesDisplay/FixtureDisplayScoreline";
...
export const CricketUpcomingWithTransitionsScoreline: React.FC = () => {
...
export const scoreline: React.FC = () => {
  return <CricketUpcomingWithTransitionsScoreline />;
};
