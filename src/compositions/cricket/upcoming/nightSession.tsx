...
import FixtureDisplayNightSession from "./controller/GamesDisplay/FixtureDisplayNightSession";
...
export const CricketUpcomingWithTransitionsNightSession: React.FC = () => {
...
export const nightSession: React.FC = () => {
  return <CricketUpcomingWithTransitionsNightSession />;
};
