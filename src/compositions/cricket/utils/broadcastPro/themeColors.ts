...
export interface BroadcastProTextOnContainer {
  title: string;
  copy: string;
  muted: string;
  secondary: string;
...
export const resolveBroadcastProAccentOnSurface = (
  background: string,
  accent: string,
): string => {
 ...
 */
export const resolveBroadcastProTextOnContainer = (
  ...
  const accent = resolveBroadcastProAccentOnSurface(
    bg,
 ...
 */
export const resolveBroadcastProTextOnGlass = (
  surfaceBase: string,
  glassPanel: string,
  preferred: BroadcastProTextOnContainer,
): BroadcastProTextOnContainer => {
  ...
  return {
    ...
    muted,
    secondary,
    accent: resolveBroadcastProAccentOnSurface(bg, preferred.accent),
  };
};
