...
export type BroadcastProVerdictAbandoned = {
  kind: "abandoned";
  status: string;
  result?: string;
};

export type BroadcastProVerdictHero = {
  kind: "hero";
  winner: string;
  contextLine: string;
};

export type BroadcastProVerdictCompact = {
  kind: "compact";
  line: string;
};

export type BroadcastProVerdictModel =
...
export const buildBroadcastProVerdictModel = (
  match: BroadcastProResultMatchData,
): BroadcastProVerdictModel | null => {
