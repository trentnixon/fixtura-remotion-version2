...
import TableHeaderCNSWPrivate from "../../modules/TableHeader/headerCNSW-private";
import { StandardRowCNSWPrivateWrapped } from "../TeamRows/row-CNSW-private";
...
export default LadderDisplayCNSWPrivate;
