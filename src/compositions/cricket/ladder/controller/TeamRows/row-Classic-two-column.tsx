...
export const StandardRowClassicTwoColumn: React.FC<TeamRowProps> = ({
  team,
  index,
  totalTeams,
  isBiasTeam,
...
export default StandardRowClassicTwoColumn;

export const StandardRowClassicTwoColumnWrapped: React.FC<TeamRowProps> = ({
  team,
  index,
  totalTeams,
  isBiasTeam,
