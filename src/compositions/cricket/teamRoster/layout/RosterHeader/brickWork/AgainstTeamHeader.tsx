...
import { AccountTeamProps } from "../Against/_types/AccountTeamProps";
import {
  DEFAULT_TEAM_HEADER_VARIANT,
  DEFAULT_TEAM_HEADER_ANIMATION_DELAY,
  MAX_TEAM_NAME_LENGTH,
} from "../Against/_utils/constants";
import {
  parseLogoSize,
  shouldApplyBackgroundColor,
} from "../Against/_utils/helpers";

export const AgainstTeamHeaderBrickWork: React.FC<AccountTeamProps> = ({
  roster,
...
export default AgainstTeamHeaderBrickWork;
