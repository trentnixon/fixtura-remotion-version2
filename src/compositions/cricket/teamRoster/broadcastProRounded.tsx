...
import RosterDisplayBroadcastProRounded from "./controller/Display/display-BroadcastProRounded";
...
export const CricketRosterBroadcastProRounded: React.FC = () => {
  ...
  return (
    <Series>
      {rosterData.map((rosterItem: RosterDataItem, i) => (
        ...
        >
          <RosterDisplayBroadcastProRounded roster={rosterItem} />
          <div
...
export const broadcastprorounded: React.FC = () => {
  return <CricketRosterBroadcastProRounded />;
};
