...
// --- Layout: CNSW-Private ---
export const StandardPerformanceRowCNSWPrivate: React.FC<
...
> = ({ performance, rowHeight, delay, index }) => {
  ...
  // Determine background color (matching top5 cnsw-private)
...
export default StandardPerformanceRowCNSWPrivate;
