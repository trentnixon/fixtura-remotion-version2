...
export const PerformancesListClassic: React.FC = () => {
  ...
  if (totalScreens <= 0) {
    console.warn(
      "[PerformancesListClassic] No screens to display, returning placeholder",
    );
    return <NoPlayersData />;
  }

  // Debug logging (remove in production)
  console.log("[PerformancesListClassic] Debug:", {
  ...
  console.log("[PerformancesListClassic] Sequences created:", {
    totalScreens,
...
// Export as Classic for compatibility with original template
export const Classic: React.FC = () => {
  return <PerformancesListClassic />;
};
