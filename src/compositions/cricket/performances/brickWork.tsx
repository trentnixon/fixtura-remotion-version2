...
import PerformancesDisplayBrickWork from "./controller/PerformancesDisplay/display-BrickWork";
import {
  getItemsPerScreen,
...
export const PerformancesListBrickWork: React.FC = () => {
  ...
  if (totalScreens <= 0) {
    console.warn(
      "[PerformancesListBrickWork] No screens to display, returning placeholder",
    );
    return <NoPlayersData />;
  }

  // Debug logging (remove in production)
  console.log("[PerformancesListBrickWork] Debug:", {
  ...
  console.log("[PerformancesListBrickWork] Sequences created:", {
    totalScreens,
...
export const BrickWork: React.FC = () => {
  return <PerformancesListBrickWork />;
};
