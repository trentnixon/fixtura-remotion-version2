...
export const PerformancesListClassicTwoColumn: React.FC = () => {
  ...
  if (
    ...
    console.warn(
      "[PerformancesListClassicTwoColumn] Invalid durationInFrames:",
  ...
  if (totalScreens <= 0) {
    console.warn(
      "[PerformancesListClassicTwoColumn] No screens to display, returning placeholder",
    );
    return <NoPlayersData />;
  }

  // Debug logging (remove in production)
  console.log("[PerformancesListClassicTwoColumn] Debug:", {
...
// Export as ClassicTwoColumn for compatibility with original template
export const ClassicTwoColumn: React.FC = () => {
  return <PerformancesListClassicTwoColumn />;
};
