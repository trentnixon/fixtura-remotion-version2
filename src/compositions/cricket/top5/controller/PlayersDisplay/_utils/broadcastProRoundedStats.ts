...
import { buildBroadcastProRoundedTop5StatMatrixCells } from "../../../../utils/broadcastProRounded/stat/buildBroadcastProRoundedStatMatrixCells";

export type { BroadcastProRoundedTripleStat };
...
export const getBroadcastProRoundedTripleStats = (
  player: PlayerData,
): BroadcastProRoundedTripleStat => {
  const cells = buildBroadcastProRoundedTop5StatMatrixCells(player);
  return {
