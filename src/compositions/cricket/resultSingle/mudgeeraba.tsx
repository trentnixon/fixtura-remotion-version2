...
import ResultSingleDisplayMudgeeraba from "./controller/ResultSingleDisplay/display-Mudgeeraba";
import {
  TransitionDirection,
...
export const ResultSingleMudgeeraba: React.FC = () => {
  ...
  const sequences = matchResults.map((match) => ({
    content: <ResultSingleDisplayMudgeeraba match={match} />,
