...
import BrickWorkSingleResult from "./controller/ResultSingleDisplay/display-brickWork";
import {
...
export const ResultSingleBrickWork: React.FC = () => {
  ...
  const sequences = matchResults.map((match) => ({
    content: <BrickWorkSingleResult match={match} />,
...
// Export as BrickWork for compatibility
export const BrickWork: React.FC = () => {
  return <ResultSingleBrickWork />;
};
