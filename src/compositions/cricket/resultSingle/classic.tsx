...
import ClassicSingleResult from "./controller/ResultSingleDisplay/display-classic";
import {
...
export const ResultSingleClassic: React.FC = () => {
  ...
  const sequences = matchResults.map((match) => ({
    content: <ClassicSingleResult match={match} />,
