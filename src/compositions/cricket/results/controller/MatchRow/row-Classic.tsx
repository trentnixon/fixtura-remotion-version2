...
import MatchCardClassic from "../../layout/MatchCard/card-classic";
import MatchCardClassicClubOnly from "../../layout/MatchCard/card-classic-clubOnly";
...
const MatchRowClassic: React.FC<MatchRowProps> = ({
  match,
  index,
  rowHeight,
}) => {
...
export default MatchRowClassic;
