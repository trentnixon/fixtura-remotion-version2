...
import MatchRowClassicTwoColumn from "../MatchRow/row-Classic-Twocolumn";
...
const ResultsDisplayClassicTwoColumn: React.FC<ResultsDisplayProps> = ({
  results,
  resultsPerScreen,
  screenIndex,
}) => {
...
export default ResultsDisplayClassicTwoColumn;
