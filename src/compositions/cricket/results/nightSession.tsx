...
import ResultsDisplayNightSession from "./controller/ResultsDisplay/display-NightSession";
import {
  TransitionDirection,
...
export const ResultsListNightSession: React.FC = () => {
...
export const nightSession: React.FC = () => {
  return <ResultsListNightSession />;
};
