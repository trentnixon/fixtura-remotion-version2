...
export const StatValue = ({
  ...
  const statStyles = getTypographyStyles(
    theme.typography?.Sports?.Stat,
    theme.componentStyles?.statValue,
    variant,
    "4xl",
    "bold",
  );
  ...
  const componentStyle: React.CSSProperties = {
    ...
    fontFamily: theme.fontClasses?.statValue?.family,
    ...style,
  };
  ...
  return (
    <span
      className={`${statStyles.className} ${className}`}
