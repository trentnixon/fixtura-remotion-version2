...
export const TeamName = ({
  ...
  const teamStyles = getTypographyStyles(
    theme.typography?.Sports?.Team,
    theme.componentStyles?.teamName,
    variant,
    "2xl",
    "bold",
  );
  ...
  const componentStyle: React.CSSProperties = {
    ...
    fontFamily: theme.fontClasses?.teamName?.family,
    ...style,
  };
  ...
  return (
    <span
      className={`${teamStyles.className} ${className}`}
