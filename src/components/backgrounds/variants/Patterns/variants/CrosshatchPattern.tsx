// variants/PatternBackground/variants/CrosshatchPattern.tsx
import React from "react";
import { AbsoluteFill, useCurrentFrame } from "remotion";
import { PatternComponentProps, ANIMATION_TYPES } from "./config";

export const CrosshatchPattern: React.FC<PatternComponentProps> = ({
  primaryColor,
  secondaryColor,
  scale = 1,
  rotation = 0,
  ...
  const patternSvg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
      ...
      <line x1="20" y1="0" x2="0" y2="20" stroke="${primaryColor}" stroke-width="1" />
    </svg>
  `;
